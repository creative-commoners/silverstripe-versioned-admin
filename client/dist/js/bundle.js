...
exports.default = (0, _redux.compose)((0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps), (0, _Injector.inject)(['FormAction'], function (FormActionComponent) {
  return {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: (0, _classnames2.default)(containerClasses, 'flexbox-area-grow') },
...
var HistoryViewerVersionList = function (_PureComponent) {
  ...
  _createClass(HistoryViewerVersionList, [{
    ...
    value: function renderMessages() {
      var _props = this.props,
          FormAlertComponent = _props.FormAlertComponent,
    ...
    value: function render() {
      var _props2 = this.props,
          HeadingComponent = _props2.HeadingComponent,
          isActive = _props2.isActive,
          VersionComponent = _props2.VersionComponent,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'thead',
            null,
            _react2.default.createElement(HeadingComponent, null)
          ),
          _react2.default.createElement(
            'tbody',
            null,
...
function mapStateToProps(state) {
  var messages = state.versionedAdmin.historyViewer.messages;
...
function historyViewerReducer() {
  ...
  switch (type) {
    ...
    case _HistoryViewerActionTypes2.default.SET_COMPARE_MODE:
      {
        ...
        return _extends({}, state, updateState);
      }

    case _HistoryViewerActionTypes2.default.SET_COMPARE_FROM:
      {
        var compareFrom = state.compareFrom,
    ...
    case _HistoryViewerActionTypes2.default.SET_COMPARE_TO:
      {
        var _compareFrom = state.compareFrom,
            _compareTo = state.compareTo;
...
var HistoryViewer = function (_Component) {
  ...
  _createClass(HistoryViewer, [{
    ...
    value: function getLatestVersion() {
      ...
      return this.getVersions().reduce(function (prev, current) {
    ...
    value: function render() {
      var _props6 = this.props,
          ...
          compareMode = _props6.compareMode,
          currentVersion = _props6.currentVersion;
...
function mapStateToProps(state) {
  var _state$versionedAdmin = state.versionedAdmin.historyViewer,
      ...
      compareMode = _state$versionedAdmin.compareMode,
      compareFrom = _state$versionedAdmin.compareFrom,
      compareTo = _state$versionedAdmin.compareTo;
